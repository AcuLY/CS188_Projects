...
GHOST_COLORS.append(formatColor(0.5, 0.5, 0.5))  # Gray
GHOST_COLORS.append(formatColor(0.2, 0.8, 0.2))  # Lime Green
GHOST_COLORS.append(formatColor(0.6, 0.2, 0.8))  # Violet
GHOST_COLORS.append(formatColor(0.0, 0.9, 0.9))  # Cyan
GHOST_COLORS.append(formatColor(0.9, 0.3, 0.3))  # Pink
GHOST_COLORS.append(formatColor(0.95, 0.87, 0.73))  # Beige
GHOST_COLORS.append(formatColor(0.1, 0.2, 0.5))  # Navy Blue
GHOST_COLORS.append(formatColor(0.8, 0.5, 0.2))  # Copper
GHOST_COLORS.append(formatColor(0.5, 0.0, 0.5))  # Indigo
GHOST_COLORS.append(formatColor(0.9, 0.6, 0.5))  # Light Coral
GHOST_COLORS.append(formatColor(0.7, 0.7, 0.0))  # Olive
GHOST_COLORS.append(formatColor(0.3, 0.3, 0.3))  # Dark Gray
    ...
    def animatePacman(self, pacman, prevPacman, image):
        ...
        if self.frameTime > 0.01 or self.frameTime < 0:
            ...
            for i in range(1, int(frames) + 1):
                ...
                refresh()
                sleep(abs(self.frameTime) / frames / 20)
        else:
